...
{
    LOG_INFO("%s is disconnecting now\n", "Client");
    ...
    // for (int msg_index = 0; msg_index < MAX_DATA_IN_FLIGHT; msg_index++)
    // {
    //     ibv_dereg_mr(ctx->msg_mr[msg_index]);
    //     free(ctx->msg[msg_index]);
    // }
