                ...
                if (wcs[index].status == IBV_WC_SUCCESS)
                {
                             ...
                             IBV_WC_RECV_RDMA_WITH_IMM)
                    {
                        ...
                        { // the first message, allocate a msg id
                            ...
                            ctx->msg[echo_msg_id].data.batch_index[MSG_NUM_OFFEST] = 0;
                            ctx->msg[echo_msg_id].data.batch_index[WINDOW_ID_OFFEST] = window_id;
                        }
#ifdef DEBUG_BATCH_MSG
...
//#define DEBUG_REVERSE_ORDER
                            ...
                            LOG_INFO("BufferID: %u, windowID: %u, data_size: %u\n",
                        ...
                        //****************************************************************new added
                        if (window_id != ctx->msg[echo_msg_id].data.batch_index[WINDOW_ID_OFFEST])
                        {
                            ...
                            // }
                            // printf("\n");
                            //window id is not the current batch, send this batch immediately
                        ...
                        uint32_t msg_index = ctx->msg[echo_msg_id].data.batch_index[MSG_NUM_OFFEST]++;
